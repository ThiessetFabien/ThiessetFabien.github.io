#!/bin/bash
# Script pour documenter la centralisation des styles

echo "Documentation de la centralisation des styles..."

# Créer le fichier de documentation
cat > /home/fabien/Projets/Portfolio/docs/styles-centralisation.md << EOF
...
echo "Documentation créée : /home/fabien/Projets/Portfolio/docs/styles-centralisation.md"

# Message de fin
echo "Centralisation des styles terminée !"
echo "Les classes CSS de css-classes.ts ont été intégrées dans les fichiers de styles appropriés."
echo "Une sauvegarde du fichier original a été créée dans backups/config/css-classes.ts"
echo "Une documentation a été ajoutée dans docs/styles-centralisation.md"
