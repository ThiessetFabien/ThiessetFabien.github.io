...
export const cnPadding: string = 'p-4';

export const cnSmallPaddingX: string = 'px-2 md:px-4';

export const cnSmallPaddingY: string = 'py-2 md:py-4';

export const cnPaddingX: string = 'px-4';

export const cnPaddingY: string = 'py-4';

export const cnPaddingTop: string = 'pt-4';

export const cnPaddingBottom: string = 'pb-4';
...
export const cnMarginX: string = 'mx-2 sm:mx-4';

export const cnMargin: string = 'm-2 sm:m-4';

export const cnMarginY: string = 'my-2 sm:my-4';

export const cnSmallMarginLeft: string = 'ml-2 md:ml-4';

export const cnMarginLeft: string = 'ml-2 sm:ml-4';

export const cnSmallMarginRight: string = 'mr-2 md:mr-4';

export const cnMarginRight: string = 'mr-2 sm:mr-4';

export const cnMarginTop: string = 'mt-2 sm:mt-4';

export const cnMarginBottom: string = 'mb-2 sm:mb-4';

export const cnSpaceY: string = 'space-y-4';

export const cnSmallSpaceY: string = 'space-y-2 ';

export const cnSpaceX: string = 'space-x-4 ';

export const cnSmallSpaceX: string = 'space-x-2';

export const cnSmallGap: string = 'gap-2 md:gap-4';

export const cnGap: string = 'gap-4';
