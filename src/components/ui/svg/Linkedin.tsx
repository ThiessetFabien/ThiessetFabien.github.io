 ...
 *
 * This component renders a LinkedIn logo as an SVG. The SVG uses the 'currentColor'
 * value for fill, allowing the icon color to be controlled via CSS.
 *
 * @component
 * @param {object} props - Component props
 * @param {string} props.className - CSS class to apply to the SVG element
 * @returns {JSX.Element} LinkedIn icon SVG
 */
